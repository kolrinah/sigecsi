...
<div class="EntraDatos">
 <table>
  <thead>
   <tr>
    <th colspan="2">            
       Planificación del Sub-Producto  
    </th>
   </tr>           
  </thead>            
  <tbody>
   <tr>
    <td colspan="2">
      ...
      <input type="text" class="Campos" id="Correo" title="Nombre del Sub-Producto" 
             readonly="readonly" 
             value="<?php echo $sp['pcodigo'].'.'.$sp['scodigo'].'&nbsp;'.trim($sp['nombre']); ?>" />
    </td>
   </tr> 
   <tr>
    <td colspan="2">  
   ...
   <tr>
    <td colspan="2">  
     ...
     <input type="text" class="Editable" id="Cantidad" title="Debe ser mayor a uno (1)"
            ...
            title="Cantidad Planificada" tabindex="1003" value="1"
     ...
     <span><?php echo $sp['unidad_medida']; ?></span>
    </td>  
   </tr>  
   <tr>
    <td width="50%">
   ...
   <tr> 
    <td>
     ...
     <input type="text" class="Fechas Editable" id="fechaI" title="Fecha Inicial"
            tabindex="1005" value="" readonly="readonly"/>
    </td>
    <td>
     <label>Fecha de Culminación:</label>
     <input type="text" class="Fechas Editable" id="fechaF" title="Fecha Final" tabindex="1006" 
  ...
  <tfoot>
   <tr>
    <td colspan="2">
     <div class="BotonIco" 
          onclick="javascript:guardarActividad(<?php echo $sp['id_subproducto']; ?>)" 
