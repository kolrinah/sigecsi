...
class Adm_tablas extends CI_Controller {
  ...
  function index()
  {
    ...
    $data['contenido']='adm_tablas/adm_tablas';    
    ...
    $tablas=$this->Crud2->listar_tablas();  
    asort($tablas);
 ...
 // CARGAMOS LA VISTA   
  ...
  function listar_campos()
  {
    ...
    $campos=$this->Crud2->listar_campos($tabla);       
  ...
  {      
     ...
     $insertado=$this->Crud2->agregar_campo($tabla, $comando);
     ...
     else 
     {
        ...
        $this->Crud2->insertar_registro('z_bitacora', $bitacora);
     }
  }
  ...
  {      
     ...
     $borrado=$this->Crud2->borrar_campo($tabla, $campo);
  ...
  function correr_sql()
  {
    ...
    $resultado=$this->Crud2->ventana_sql($sql);
