...
function agregar_campo(tabla)
{
  ...
  fila+='<input type="text" id="Nombre" class="Nom Editable" tabindex="1000" title="Escriba el Nombre del Campo"/>';
  fila+='</td>';
  fila+='<td>';
  fila+='</td></tr>';
  fila+='<tr><td>';
  fila+='<label>Tipo de Dato:</label><br/>';
  fila+='<select class="Campos Editable" id="Tipo" title="Tipo de Dato" tabindex="1001" ';
  ...
  fila+='<input type="text" id="Longitud" class="Nom Editable" tabindex="1002" title="Longitud"'+plus+'/>';  
         
  fila+='</td></tr>';
  fila+='<tr><td>';
  fila+='<label>Nulo:</label><br/>';
  fila+='<select class="Campos Editable" id="Nulo" title="Tipo de Dato" tabindex="1003">';
  ...
  fila+='<input type="text" id="Omision" class="Nom Editable" tabindex="1004" title="Valor de Omisión"/>';
  fila+='</td></tr>';
  fila+='</tbody>';
  fila+='<tfoot>';
